...
use crate::{bytecode::Instruction, get_or_init, get_or_init_option, vm::{bytecode::IrInstruction, class::ClassRef, java_error::JavaError, result::VMResult, value::{ReferenceType, Value}, VmError, VM}};
